...
def attribution_tree(attr_file:str,tokens_file:str,example_index:int,threshold:int):
    ...
    name = '/home/newdisk/szk/tf_vis/attattr/output/attr_tree/edges_list{0}.json' 
    with open(name.format(example_index),'w') as file_object:
        json.dump(edges_list,file_object)
